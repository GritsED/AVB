...
public class CompanyController {
    ...
    @PostMapping
    public CompanyDto addCompany(@RequestBody @Valid NewCompanyDto newCompanyDto) {
    ...
    @GetMapping
    public List<CompanyDto> getAllCompanies(@RequestParam(defaultValue = "0") @Min(0) Integer from,
    ...
    public CompanyDto updateCompany(@PathVariable Long companyId, @RequestBody UpdateCompanyDto updateCompanyDto) {
